...
";
            ...
            Assert.Equal(1,newCal.CalendarComponents.Count);
            Assert.Equal("VEVENT",newCal.CalendarComponents.First().Key);
            Assert.Equal(4, newCal.CalendarComponents.First().Value.First().Properties.Count);
